              ...
              <div className="flex flex-col">
                <p className="md:text-xl text-lg font-bold flex gap-2">
                  ...
                  >
                    ...
                    <path d="M8 19a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2" />
                    <path d="M9 21a1 1 0 1 1-2 0 1 1 0 0 1 2 0z" />
                    <path d="M17 21a1 1 0 1 1-2 0 1 1 0 0 1 2 0z" />
                  </svg>
                  {property.garages}
                </p>
                <p className="text-sm text-gray">
